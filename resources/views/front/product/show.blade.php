                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{ $product->image_url }}" id="current" alt="{{ $product->image }}">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i class="lni lni-tag"></i> Drones:<a href="javascript:void(0)">{{$product->category->name}}
                                </a></p>
                            <h3 class="price">{{Currency::format($product->price,'ILS')}}<span>{{currency::format($product->compare_price)}}</span></h3>
